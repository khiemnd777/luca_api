...
CREATE INDEX IF NOT EXISTS idx_supplier_code_trgm_norm  ON suppliers USING gin (code_norm gin_trgm_ops);
CREATE INDEX IF NOT EXISTS idx_supplier_name_trgm_norm  ON suppliers USING gin (name_norm gin_trgm_ops);
