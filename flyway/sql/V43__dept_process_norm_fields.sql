...
CREATE INDEX IF NOT EXISTS idx_process_code_trgm_norm  ON processes USING gin (code_norm gin_trgm_ops);
CREATE INDEX IF NOT EXISTS idx_process_name_trgm_norm  ON processes USING gin (name_norm gin_trgm_ops);
